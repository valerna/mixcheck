...
/**
 * A simple (in memory) queue of data that needs be sent to MixCheck.
 *
 * Queued data is sent to MixCheck at the end of the current page load (during the shutdown hook).
 *
 ...
 *
 * This also ensures that the "Order sent to MixCheck" notes appear in the order notes section after
