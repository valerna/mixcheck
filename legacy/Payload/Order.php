...
namespace OM4\MixCheck\Payload;
...
use OM4\MixCheck\Payload\Item\BillingTrait;
use OM4\MixCheck\Payload\Item\MetaData;
use OM4\MixCheck\Payload\Item\ShippingTrait;
...
class Order extends Item {
	...
	protected static $property_types = array(
		...
		'line_items'            => '\\OM4\\MixCheck\\Payload\\Collection\\LineItems',
		...
		'downloadable_files'    => '\\OM4\\MixCheck\\Payload\\Collection\\DownloadableFiles',
		'customer_note'         => 'string',
		'notes'                 => '\\OM4\\MixCheck\\Payload\\Collection\\Notes',
		'meta_data'             => '\\OM4\\MixCheck\\Payload\\Item\\MetaData',
	);
	 ...
	 *
	 * @since  1.2.0
	 * @var  \OM4\MixCheck\Payload\Collection\LineItems
	 */
	 ...
	 *   file from.
	 *
	 * @var  \OM4\MixCheck\Payload\Collection\DownloadableFiles
	 */
	 ...
	 *
	 * @var  \OM4\MixCheck\Payload\Collection\Notes
	 */
	protected $notes;
	 ...
	 *
	 * @since  1.7.1
	 * @var  \OM4\MixCheck\Payload\Item\MetaData
	 */
	protected $meta_data;
}
