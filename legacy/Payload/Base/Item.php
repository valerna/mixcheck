...
namespace OM4\MixCheck\Payload\Base;

use ArrayIterator;
use Iterator;
use OM4\MixCheck\Exception\InvalidPropertyException;
use OM4\MixCheck\Exception\InvalidTypeException;
use OM4\MixCheck\Exception\MissingDataException;
use OM4\MixCheck\Exception\MissingSampleException;
use OM4\MixCheck\Payload\Base\Base;
...
abstract class Item extends Base {
	...
	final protected function validate( $key, $value ) {
		...
		if (
			( is_scalar( $value ) xor $value instanceof \OM4\MixCheck\Payload\Base\Base ) &&
