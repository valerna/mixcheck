...
/**
 * This class is responsible for retrieving OM4\MixCheck\Feed\Feed objects.
 *
 * @deprecated 2.0.0
 */
class FeedFactory {
	...
	/**
	 * Obtain the (active and valid) MixCheck Feeds that are configured for the specified trigger.
	 ...
	 *
	 * @return Feed[] Array of \OM4\MixCheck\Feed\Feed objects
	 */
	...
	/**
	 * Obtain the number of existing MixCheck Feeds that have the specified webhook URL and trigger.
	 * This is used to help ensure that two MixCheck Feeds can't exist with the same webhook URL and trigger combination.
	 *
	 * @param string        $webhook_url     MixCheck Search for this Webhook URL.
	...
	/**
	 * Obtain the number of existing MixCheck Feeds that have the specified title.
	 * This is used to help ensure that two MixCheck Feeds can't exist with the same title.
	 *
	 * @param string   $title           MixCheck Feed Title.
	...
	/**
	 * Obtain the number of configured MixCheck feeds.
	...
	/**
	 * Obtain all of the configured active and valid MixCheck feeds.
	 * This only includes published (active) ones.
	 *
	 * @return array
	 */
