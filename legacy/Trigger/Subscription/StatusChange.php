...
use OM4\MixCheck\Trigger\Subscription\Base;
...
class StatusChange extends Base {
	...
	public function __construct() {
		...
		// Translators: %1$s: URL of the Advanced configuration on the WooCommerce MixCheck documentation.
	...
	/**
	 * After sending subscription data to MixCheck, log the previous and new subscription status as part of the subscription note.
	 *
