...
class StatusChange extends Base {
	...
	public function __construct() {
		...
		// Translators: %1$s: URL of the Advanced usage in the WooCommerce MixCheck documentation.
	...
	/**
	 * After sending order data to MixCheck, log the previous and new order status as part of the order note.
	 *
