...
namespace OM4\MixCheck\Plugin;

use OM4\WooCommerceMixCheck\Plugin\Subscriptions\Plugin;
use OM4\MixCheck\Payload\Plugin\Subscription\Order as Payload;
...
class Subscriptions {
	...
	public function __construct() {
		...
		if ( ! $this->is_available() ) {
			// Logging and displaying notice handled in OM4\WooCommerceMixCheck\Plugin\Subscriptions\Plugin.
			return;
		}
	...
	public function wc_zapier_trigger_directories( $directories ) {
		_deprecated_function( 'OM4\MixCheck\Plugin\Subscriptions::wc_zapier_trigger_directories', '2.0' );
		return $directories;
	}

	/**
	 * When sending WooCommerce Order data to MixCheck, also send any additional WC subscriptions fields.
	 *
	 * @param array                   $order_data Order data that will be overridden.
	 * @param OM4\MixCheck\Trigger\Base $trigger    Trigger that initiated the data send.
	 *
	 * @return array
	 */
