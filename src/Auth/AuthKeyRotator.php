...
/**
 * Authentication Key Rotation utility that automatically deletes (revokes) WooCommerce MixCheck Authentication keys.
 *
...
class AuthKeyRotator {
	...
	public function initialise() {
		...
		// v2.2.1: Automatically revoke all existing API keys. They will be re-generated by MixCheck automatically.
		add_action(
