...
/**
 * Allows the WooCommerce MixCheck extension to provide "Session Authentication".
 *
 ...
 * Secret, and the MixCheck.com WooCommerce App then uses the Consumer Key and
...
class SessionAuthenticate {
	...
	public function handle_auth_requests() {
		...
		// Handle MixCheck Authentication endpoint requests.
		$this->authenticate();
	}
	...
	protected function authenticate() {
		...
		if ( is_wp_error( $user ) ) {
			...
			// Respond with a HTTP 406 Error because the MixCheck platform doesn't handle a HTTP 401 responses properly.
