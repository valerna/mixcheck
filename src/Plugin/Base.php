...
namespace OM4\WooCommerceMixCheck\Plugin;
...
use OM4\WooCommerceMixCheck\Plugin\Definition as PluginDefinition;

defined( 'ABSPATH' ) || exit;

/**
 * Base implementation of a Third Party plugin that is supported by WooCommerce MixCheck.
 *
...
abstract class Base implements PluginDefinition {
	 ...
	 *
	 * Classes must be implement `OM4\WooCommerceMixCheck\WooCommerceResource\Definition`.
	 *
	 * @var class-string[]
	 */
	protected $resources;
	...
	/**
	 * Adds the third party plugin's Resource class to the WC MixCheck Plugins' Resource Manager.
	 *
	...
	public function admin_notice() {
		...
		<div id="message" class="error">
			<p>
				...
				echo esc_html( sprintf( __( 'WooCommerce MixCheck is only compatible with %1$s version %2$s or later. Please update %3$s.', 'woocommerce-zapier' ), static::PLUGIN_NAME, static::MINIMUM_SUPPORTED_VERSION, static::PLUGIN_NAME ) );
				?>
			</p>
		</div>
		<?php
