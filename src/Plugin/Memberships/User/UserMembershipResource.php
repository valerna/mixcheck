...
class UserMembershipResource extends CustomPostTypeResource {
	...
	/**
	 * Whenever a User Membership status is changed, trigger the appropriate WooCommerce MixCheck hook
	...
	public function wc_memberships_user_membership_status_changed( $user_membership, $old_status, $new_status ) {
		/**
		 * Execute the WooCommerce MixCheck handler for the "User Membership status changed (any status)" trigger rule.
		 *
		 * @internal
		 * @since 2.10.0
		 *
		...
		/**
		 * Execute the WooCommerce MixCheck handler for the "User Membership status changed to %s" trigger rule.
		 *
		 * @internal
		 * @since 2.10.0
		 *
