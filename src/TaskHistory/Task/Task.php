...
namespace OM4\WooCommerceMixCheck\TaskHistory\Task;

use OM4\WooCommerceMixCheck\Exception\InvalidTaskException;
 ...
 *
 * @since 2.0.0
 * @since 2.8.0 Moved from OM4\WooCommerceMixCheck\TaskHistory\Task to OM4\WooCommerceMixCheck\TaskHistory\Task\Task.
 */
