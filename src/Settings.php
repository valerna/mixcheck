...
class Settings {
	...
	public function initialise() {
		add_filter(
			...
			function ( $tabs ) {
				$tabs['wc_zapier'] = __( 'MixCheck', 'woocommerce-zapier' );
				return $tabs;
			},
			29
		);
	...
	public function get_settings_for_settings_screen() {
		return array(
			'section_title' => array(
				'name' => __( 'WooCommerce MixCheck', 'woocommerce-zapier' ),
				'type' => 'title',
				'desc' => '<p>' . __( 'Configure your WooCommerce MixCheck integration here.', 'woocommerce-zapier' ) . '</p>',
	...
	/**
	 * Whether or not to the 1.9.x Legacy MixCheck Feed functionality is enabled.
	 *
	 * @return bool
	 */
