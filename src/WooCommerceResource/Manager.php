 ...
 * Resource Manager.
 *
 * Responsible for loading and accessing WooCommerce MixCheck Resource Type definitions.
 *
 * @since 2.0.0
 */
class Manager {
	...
	public function initialise() {
		 ...
		 *
		 * Any classes added using this filter must implement `OM4\WooCommerceMixCheck\WooCommerceResource\Definition`
		 *
		 * @internal
		 * @since 2.0.0
		 *
