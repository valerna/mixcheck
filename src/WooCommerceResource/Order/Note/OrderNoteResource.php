...
class OrderNoteResource extends Base {
	...
	/**
	 * Whenever a WooCommerce Order Note is created, fire the appropriate WooCommerce MixCheck hook if the
	...
	public function order_note_added( $order_note_id ) {
		...
		/**
		 * Execute the WooCommerce MixCheck handler for the Order Note created trigger rule.
		 *
		 * @internal
		 * @since 2.9.0
		 *
	...
	public function deleted_comment( $comment_id, $comment ) {
		...
		/**
		 * Execute the WooCommerce MixCheck handler for the Order Note deleted trigger rule.
		 *
		 * @internal
		 * @since 2.8.0
		 *
