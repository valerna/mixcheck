...
trait VariationTypesTrait {
	 ...
	 * that are allowed to be used in MixCheck.
	 *
	...
	protected function get_variable_product_types_to_variation_types() {
		/**
		 * The product variation types that are allowed to be used in MixCheck.
		 *
		 * @internal
		 * @since 2.5.1
		 *
		...
		/**
		 * Get the variable product types that are allowed to be used in MixCheck.
		 *
		 * @since 2.5.1
		 *
		 * @return string[]
	...
	/**
	 * Get the product variation types that are allowed to be used in MixCheck.
	 *
	 * @since 2.5.1
	 *
	 * @return string[]
