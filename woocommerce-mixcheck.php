...
/*
Plugin Name: WooCommerce MixCheck
...
function wc_zapier_incompatible_php_version_admin_notice() {
	...
	$message = __( 'WooCommerce MixCheck is disabled because it is only compatible with PHP version %1$s or later. Please contact your web host to upgrade from PHP version %2$s to a newer version. We recommend using PHP 7.4 or greater.', 'woocommerce-zapier' );
